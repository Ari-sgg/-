...
function handleExplodeAction(row,col,game,cellEl,tableEl){
    ...
    panelEl.innerHTML=` <h3>你失败了，${game.seconds}秒</h3>`;
...
function renderWelcome(){
    ...
    buttonEl.onclick=()=>{    
        let game = new Game(12, 12, 0.05);
    game.shuffle();
    renderTable(game);}


    buttonEl=gameEl.querySelector('button#leve0');
    buttonEl.onclick=()=>{    
        let game = new Game(16, 18, 0.05);
    game.shuffle();
    renderTable(game);}
